...
{
	function nv_block_config_mslider( $module, $data_block, $lang_block )
	{
        ...
        $html .= '<td>';
        $block_template = array( 'block_flex' => $lang_block['block_flex'], 'block_bx' => $lang_block['block_bx'], 'block_skitter' => $lang_block['block_skitter'], 'block_magic' => $lang_block['block_magic'], 'block_owl' => $lang_block['block_owl'], 'block_jssor' => $lang_block['block_jssor'] );
	...
	function nv_block_config_mslider_submit( $module, $lang_block )
	{
		global $nv_Request;
		$return = array();
		$return['error'] = array();
	...
	function nv_block_mslider( $block_config )
	{
		...
		if( ! empty( $list ) )
		{
			...
			foreach( $list as $l )
			{
				...
				if( ! empty( $l['link'] ) ) $xtpl->parse( 'main.loop.link' );
				if( ! empty( $l['hometext'] ) ) $xtpl->parse( 'main.loop.hometext' );
